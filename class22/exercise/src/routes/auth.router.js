...
import { authtorization, generateToken, passportCall } from '../utils.js';

const router = Router();

const users = [{
    name: 'Joaquin',
    email: 'joaquin.elia@hotmail.com',
    password: '1234'
}];
...
router.get('/current-custom', passportCall('jwt'), authtorization('admin'), (req, res) =>{
    res.send({status: 'success', payload: req.user});
});
